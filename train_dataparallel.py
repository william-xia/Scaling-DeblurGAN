	...
	for epoch in range(opt.epoch_count, opt.niter + opt.niter_decay + 1):
		...
		for i, data in enumerate(dataset):
			...
			if total_steps % opt.print_freq == 0:
				...
				print('Generator Loss: ',model.loss_G,' | Discriminator Loss ',model.loss_D)
...
if __name__ == '__main__':
	...
	#opt.dataroot = 'D:\\NYU_Courses\\Spring 2022\\ECE-GY 9143\\Project\\DeblurGAN\\train_dataset'
	opt.niter = 40
	opt.niter_decay = 60
	opt.dataroot = './train_dataset'
	...
	print('Single GPU Total Training Time: ', total_train_time)
